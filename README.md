...
galaxies. Now, let us ask some questions.
   ...
   - **Where to look?**: It is important to know where we can find various data products. For 
      various telescopes, there are dedicated websites to search and download data.
   ...
   - **Visualisation: HST vs JWST**: Here I will show you how Abell 2744 looks like with Hubble
   Space Telescope (HST) and James Webb Space Telescope (JWST).
      - Data format: .fits
      ...
      links below. <code style="color : red">Please keep in mind that these are heavy data products 
      (each one > 1 GB).text</code> Hence, it is okay if you are not able to download these. 
   ...
   if time permits, I will show some exampled of 
